...
<html>
<head>
	<title>Aprobación de reserva</title>
...
<body>
Hola <h1> {{$prestamo->cliente->nombre}} </h1>
<small>
Su reserva ha sido aprobada. Le enviarémos un correo electrónico para que pueda hacer el pago correspondiente
</small>
