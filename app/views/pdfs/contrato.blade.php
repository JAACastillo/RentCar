...
<html lang="en">
	<head>
		...
		<style>
	    	...
	    	#header{position: absolute; margin-top: -50px; width: 100%; font-size: 10px}
	...
	<body>
		...
		<div class="contenido">
			<div class="pagina1">
				...
				<br>
				<div>
					<span style="width: 50%; float:left;"><img alt="600x300" src="assets/img/combustible.png" width="80px"></span>
					<span class="right" style="width: 50%; left: 530px;"><img alt="600x300" src="assets/img/combustible.png" width="80px"></span>
					<br/><br/>
					<div class="borde"></div>
